...
export default function BraceletsPage() {
  ...
  const braceletTypes = ['Chain', 'Bangle', 'Cuff', 'Charm', 'Beaded', 'Tennis', 'Wrap'];
  ...
  const fetchBracelets = async () => {
    ...
    try {
      ...
      params.append('category', 'bracelets');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4 md:mb-0">Bracelets Collection</h1>
        ...
        {showFilters && (
          <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <h3 className="font-medium mb-3">Bracelet Type</h3>
